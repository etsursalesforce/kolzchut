...
function efOpenGraphMetaPageHook( &$out, &$sk ) {
	global $wgLogo, $wgSitename, $wgXhtmlNamespaces, $egFacebookAppId, $egFacebookAdmins, $egFacebookDefaultImage; /* WR: added $egFacebookDefaultImage */
	...
	if ( isset( $out->mMainImage ) && ( $out->mMainImage !== false ) ) {
		...
		$meta["og:image"] = $egFacebookDefaultImage;	/* WR 16-07-2013: Ability to set a default image. */
	}
