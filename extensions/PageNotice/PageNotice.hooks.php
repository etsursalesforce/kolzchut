...
class PageNoticeHooks {
	...
	public static function renderHeader( Article &$article, &$outputDone, &$pcache ) {
		...
		$header = $out->msg( "top-notice-$name" )->inContentLanguage();
		$nsheader = $out->msg( "top-notice-ns-$ns" )->inContentLanguage();
	...
	public static function renderFooter( Article $article ) {
		...
		$footer = $out->msg( "bottom-notice-$name" )->inContentLanguage();
		$nsfooter = $out->msg( "bottom-notice-ns-$ns" )->inContentLanguage();
