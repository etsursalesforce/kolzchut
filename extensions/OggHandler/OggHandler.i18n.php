...
$messages['qqq'] = array(
	...
	'ogg-short-audio' => 'File details for Ogg sound (audio) files, short version.
Parameters:
* $1 - stream type name. Any one of the following: Vorbis, Speex, FLAC
* $2 - duration of the sound/audio (localized) - e.g. 1m34s
{{Related|Ogg-short}}',
	'ogg-short-video' => 'File details for Ogg video files, short version.
Parameters:
...
{{Related|Ogg-short}}',
	'ogg-long-audio' => 'File details for Ogg sound (audio) files, long version.
...
{{Related|Ogg-long}}',
	'ogg-long-video' => 'File details for Ogg video files, long version.
...
{{Related|Ogg-long}}',
	'ogg-long-multiplexed' => '{{doc-important|Start with a lowercase letter, unless the first word is "Ogg".}}
...
* $5 - height of the video (in pixels)
{{Related|Ogg-long}}',
	'ogg-long-general' => 'File details for Ogg generic (non-video, non-audio) files, long version.
...
* $3 - bit-rate (localized) - e.g. 97kbps
{{Related|Ogg-long}}',
	'ogg-long-error' => 'Used as error message. Parameters:
* $1 - error message. e.g. File not found, invalid stream, etc.',
	'ogg-play' => '{{Identical|Play}}',
	'ogg-pause' => 'Used as button text.
{{Identical|Pause}}',
	'ogg-stop' => '{{Identical|Stop}}',
	'ogg-play-video' => 'Used as HTML <code><nowiki><button></nowiki></code> title and HTML <code><nowiki><img></nowiki></code> alt.

If sound, the message {{msg-mw|Ogg-play-sound}} is used instead.',
	'ogg-play-sound' => 'Used as HTML <code><nowiki><button></nowiki></code> title and HTML <code><nowiki><img></nowiki></code> alt.

If video, the message {{msg-mw|Ogg-play-video}} is used instead.',
	'ogg-no-player' => 'Used as error message in JavaScript code.',
	'ogg-no-xiphqt' => 'Used as error message in JavaScript code.',
...
{{Related|Ogg-player}}',
	'ogg-player-oggPlugin' => '{{Related|Ogg-player}}',
...
{{Related|Ogg-player}}',
	'ogg-player-thumbnail' => '{{Related|Ogg-player}}',
	'ogg-player-soundthumb' => '{{Related|Ogg-player}}',
	'ogg-player-selected' => 'This message follows the following Player messages:
{{Related|Ogg-player}}',
	'ogg-use-player' => 'Used as caption for Player selector.

This message is followed by a list of the players.

"Use player:" means about "Select a player to use:".',
	'ogg-more' => '{{Identical|More...}}',
	'ogg-dismiss' => '{{Identical|Close}}',
	'ogg-download' => '{{Identical|Download}}',
	'ogg-desc-link' => 'Used as link text in JavaScript code.

The link points to Description page for this file.',
	'ogg-oggThumb-version' => 'Parameters:
* $1 - version number, 0.9 (hard-coded)
See also:
* {{msg-mw|ogg-oggThumb-failed}}',
	'ogg-oggThumb-failed' => 'See also:
* {{msg-mw|ogg-oggThumb-version}}',
);
...
გთხოვთ, <a href="http://www.mediawiki.org/wiki/Extension:OggHandler/Client_download">ჩამოტვირთეთ XiphQT</a> ან აირჩიეთ სხვა დამკვრელი.',
	...
	'ogg-oggThumb-failed' => 'oggThumb-მა ვერ მოახერხა მინიატიურის შექმნა.',
);
...
$messages['pt-br'] = array(
	...
	'ogg-long-error' => 'Arquivo ogg inválido: $1',
	'ogg-play' => 'Reproduzir',
	'ogg-pause' => 'Pausar',
	'ogg-stop' => 'Parar',
	'ogg-play-video' => 'Reproduzir vídeo',
