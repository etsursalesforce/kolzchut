	...
	'makeOptionsBox' : function ( selectedPlayer, params ) {
		...
		for ( var i = 0; i < this.players.length + 1; i++ ) {
			...
			if ( i == this.players.length ) {
				...
				// ogg-player-videoElement, ogg-player-oggPlugin, ogg-player-cortado,
				// ogg-player-vlc-mozilla, ogg-player-vlc-activex, ogg-player-quicktime-mozilla,
				// ogg-player-quicktime-activex, ogg-player-totem, ogg-player-kmplayer,
				// ogg-player-kaffeine, ogg-player-mplayerplug-in
				player = this.players[i];
